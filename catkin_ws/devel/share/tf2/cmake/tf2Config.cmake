...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/geometry2/tf2)
  set(tf2_DEVEL_PREFIX /afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/devel)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/install)
...
if(NOT "/afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/geometry2/tf2/include;/usr/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/geometry2/tf2/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/geometry2/tf2/${idir}'.  ${_report}")
    endif()
