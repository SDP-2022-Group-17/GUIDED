...
if("TRUE" STREQUAL "TRUE")
  set(rotate_recovery_SOURCE_PREFIX /afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/navigation/rotate_recovery)
  set(rotate_recovery_DEVEL_PREFIX /afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/devel)
  ...
  set(rotate_recovery_INSTALL_PREFIX /afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/install)
...
if(NOT "/afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/navigation/rotate_recovery/include " STREQUAL " ")
  set(rotate_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/navigation/rotate_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/navigation/rotate_recovery/${idir}'.  ${_report}")
    endif()
