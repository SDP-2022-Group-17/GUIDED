...
if("TRUE" STREQUAL "TRUE")
  set(tf2_ros_SOURCE_PREFIX /afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/geometry2/tf2_ros)
  set(tf2_ros_DEVEL_PREFIX /afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/devel)
  set(tf2_ros_INSTALL_PREFIX "")
  set(tf2_ros_PREFIX ${tf2_ros_DEVEL_PREFIX})
else()
  set(tf2_ros_SOURCE_PREFIX "")
  set(tf2_ros_DEVEL_PREFIX "")
  set(tf2_ros_INSTALL_PREFIX /afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/install)
...
if(NOT "/afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/geometry2/tf2_ros/include " STREQUAL " ")
  set(tf2_ros_INCLUDE_DIRS "")
  set(_include_dirs "/afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/geometry2/tf2_ros/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/afs/inf.ed.ac.uk/user/s19/s1911027/catkin_ws/src/geometry2/tf2_ros/${idir}'.  ${_report}")
    endif()
